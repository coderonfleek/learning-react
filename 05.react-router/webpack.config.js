...
module.exports = {
  ...
  devServer: {
    ...
    historyApiFallback: true //This tells webpack server to always serve index.html so that react router does the routing and not the server. NB: This is only useful in development not in production
  }
};
